/*
  ...
  including batch lookup via ID or QR, GPS location, weather data, product information (name, brand, type,
  quantity, unit, location, manufacture date, expiry date), rating of previous chain (processor), and document uploads.
  ...
  - `product_type` (text) - Type of product (fertilizer, feed, etc.)
  - `quantity` (decimal) - Product quantity
  - `unit` (text) - Unit of measurement (kg, liters, pieces, etc.)
  - `location` (text) - Manufacturing location/facility name
